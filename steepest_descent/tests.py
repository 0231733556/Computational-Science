...
def constraint_tests():
    ...
    f_c, g_c, h_c = make_penalized_function(f, grad, hess, model4a_constraint_8_16, c8_16["xR"], c8_16["yR"], c8_16["R"], k=100)
    print("=================== Conjugate ===================")
...
def inequality_constraint_tests():
    ...
    grad = lambda u: fn.model4a_gradient(u, m4a["A"], m4a["g_zero"])
    hess = lambda u: fn.model4a_hessian(u, m4a["A"], m4a["g_zero"])
    f_c, g_c, h_c = make_penalized_function(f, grad, hess, model4a_constraint_8_17, c8_17["xR"], c8_17["yR"], c8_17["R"], k=100)
    f_c2, g_c2, h_c2 = make_penalized_function(f, grad, hess, model4a_constraint_8_18, c8_18["xR"], c8_18["yR"], c8_18["R"], k=100)
